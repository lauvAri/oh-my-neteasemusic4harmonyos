...
description: >
  HarmonyOS 6.1/6.1.1/NEXT development: ArkTS, ArkUI, Stage model, 60+ Kit APIs (CameraKit,
  AudioKit, AVPlayer, ImageKit, ScanKit, AccountKit, PushKit, MapKit, ShareKit, FormKit, etc.),
  UI components, state management (@State, @Prop, @Link, @Observed, @ComponentV2, AppStorageV2),
  navigation (NavPathStack), animation (animateTo, geometryTransition), networking (axios,
  WebSocket), data persistence (relationalStore, preferences, fileIo), concurrency (TaskPool,
  Worker), testing, security, performance. 105+ code examples. Triggers: HarmonyOS, ArkTS,
  .ets, DevEco Studio, UIAbility, @State, @Prop, @Link, @Observed, @ComponentV2, NavPathStack,
  LazyForEach, animateTo, TaskPool, Tabs, Swiper, relationalStore, CameraKit, AudioKit,
  AVPlayer, ImageKit, ScanKit, MapKit, FormKit, AppStorageV2, PersistenceV2, axios, lottie,
  dayjs, API 22/23/24, HarmonyOS 6.1/6.1.1, HAP, WaterFlow, Grid, TextInput, AlertDialog,
  Refresh, swipeAction, WebSocket, colorMode, PaymentKit, AVSessionKit, @Local, @Param,
  @Event, imageknife, onContinue.
---
